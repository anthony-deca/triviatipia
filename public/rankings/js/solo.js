//   radio button
      ...
      learnLink.addEventListener("click", () => {
        ...
        document.getElementById("category").style.background = "linear-gradient(#ff8a00, #e52e71)";
        document.getElementById("minutes").style.background = "linear-gradient(#ff8a00, #e52e71)";
        document.getElementById("type").style.background = "linear-gradient(#ff8a00, #e52e71)";
        document.getElementById("question").style.background = "linear-gradient(#ff8a00, #e52e71)";
        document.getElementById("difficulty").style.background = "linear-gradient(#ff8a00, #e52e71)";
